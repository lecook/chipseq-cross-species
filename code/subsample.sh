...
TRA=($(for file in *_PPq30.sorted.dedup.bam; do echo $file |cut -d "_" -f 1-2;done))
...
samtools view -bs $frac ${tr}_PPq30.sorted.dedup.bam > ${tr}_downSampled.PPq30.sorted.dedup.bam
