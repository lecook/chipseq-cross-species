...
nohup RepeatModeler -database dunnart -pa 20 >& output/repeat_modeler/repeat_modeler/repeatmodeler.out
...
```{bash eval=FALSE}
faSplit byName data/genomic_data/Scras_dunnart_assem1.0_pb-ont-illsr_flyeassem_red-rd-scfitr2_pil2xwgs2_60chr.fasta data/genomic_data/smiCra1_split/
```
...
```{bash eval=FALSE}
axtChain -linearGap=loose -scoreScheme=../../bin/GenomeAlignmentTools/HoxD55.q data/genomic_data/mm10_smiCra1.axt data/genomic_data/mm10.2bit data/genomic_data/smiCra1.2bit output/wga/axt_chain/mm10_smiCra1.chain
```
...
```{bash eval=FALSE}
chainMergeSort data/genomic_data/*.chain > output/wga/chain_merge/smiCra1_mm10.chain
```
...
```{bash eval=FALSE}
python3 RepeatFiller.py -c output/wga/axt_chain/smiCra1_mm10.chain -T2 mm10.2bit -Q2 smiCra1.2bit
...
```{bash eval=FALSE}
patchChain.perl smiCra1_mm10.chain /data/projects/punim0586/lecook/chipseq-cross-species/data/genomic_data/mm10.2bit /data/projects/punim0586/lecook/chipseq-cross-species/data/genomic_data/smiCra1.2bit /data/projects/punim0586/lecook/chipseq-cross-species/data/genomic_data/mm10.chrom.sizes /data/projects/punim0586/lecook/chipseq-cross-species/data/genomic_data/smiCra1.chrom.sizes -chainMinScore 5000 -gapMaxSizeT 500000 -gapMaxSizeQ 500000 -gapMinSizeT 30 -gapMinSizeQ 30 -numJobs 10 -jobDir jobs -jobList jobList -outputDir output/wga/pslOutput -minEntropy 1.8 -windowSize 30 -minIdentity 60 -lastzParameters "--format=axt K=1500 L=2500 M=0 T=0 W=5 Q=/data/projects/punim0586/lecook/chipseq-pipeline/cross_species/bin/GenomeAlignmentTools/example/HoxD55.q"
```
...
```{bash eval=FALSE}
axtChain -psl -linearGap=loose -scoreScheme=bin/GenomeAlignmentTools/HoxD55.q all.psl data/genomic_data/mm10.2bit data/genomic_data/smiCra1.2bit output/wga/patch_chain/smiCra1_mm10_patched.chain
```
