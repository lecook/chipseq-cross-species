...
message("cluster 1 promoter peaks: ", dim(fread(paste0(filterPeaks_dir, "cluster1_dunnart_downSampled_promoter_peaks.narrowPeak"), header=FALSE, sep="\t", quote = ""))[1])
message("cluster 2 promoter peaks: ", dim(fread(paste0(filterPeaks_dir, "cluster2_dunnart_downSampled_promoter_peaks.narrowPeak"), header=FALSE, sep="\t", quote = ""))[1])
message("cluster 3 promoter peaks: ", dim(fread(paste0(filterPeaks_dir, "cluster3_dunnart_downSampled_promoter_peaks.narrowPeak"), header=FALSE, sep="\t", quote = ""))[1])
```
...
TRA=($(for file in output/peaks/E1*_peaks.narrowPeak; do echo $file |cut -d "_" -f 1;done))
...
annotatePeaks.pl output/peaks/${tr}_promoter_peaks.narrowPeak mm10 -CpG > output/annotations/E10.5_enhancer_peaks_homerAnnot.txt

annotatePeaks.pl output/peaks/${tr}_enhancer_peaks.narrowPeak mm10 -CpG > output/annotations/E10.5_enhancer_peaks_homerAnnot.txt
