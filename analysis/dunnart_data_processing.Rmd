...
```{bash}
less A-3_H3K27ac_vs_A-1_input_macs2_default_peaks.narrowPeak | wc -l
```

```{bash}
less A-2_H3K4me3_vs_A-1_input_macs2_default_peaks.narrowPeak | wc -l
```

```{bash}
less B-3_H3K27ac_vs_B-1_input_macs2_default_peaks.narrowPeak | wc -l
```

```{bash}
less B-2_H3K4me3_vs_B-1_input_macs2_default_peaks.narrowPeak | wc -l
```
...
```{r echo=FALSE}
kable(A2, caption="A2 H3K4me3 fraction of reads in peaks")
```

```{r echo=FALSE}
kable(A3, caption="A3 H3K27ac fraction of reads in peaks")
```

```{r echo=FALSE}
kable(B2, caption="B2 H3K4me3 fraction of reads in peaks")
```

```{r echo=FALSE}
kable(B3, caption="B3 H3K27ac fraction of reads in peaks")
```
...
less H3K4me3_only.narrowPeak | wc -l
```
...
less H3K27ac_only.narrowPeak | wc -l
```
...
less H3K4me3_and_H3K27ac.narrowPeak | wc -l
```
...
less dunnart_promoter_peaks.narrowPeak | wc -l
less dunnart_enhancer_peaks.narrowPeak | wc -l
```
