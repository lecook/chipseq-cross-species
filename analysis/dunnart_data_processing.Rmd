...
![Pearson correlation dunnart BAM files](pearsoncor_multibamsum.pdf){width=600px, height=500px}
...
![Fingerprint plot for dunnart BAM files](multiBAM_fingerprint.pdf){width=600px, height=500px}
...
![Fragment size for read pairs in a BAM file](bamPEFragmentSize_hist.pdf){width=600px, height=500px}
