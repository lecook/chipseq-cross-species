...
conda create --name chip python=3 bowtie2 samtools picard deeptools multiqc phantompeakqualtools preseq macs2 bedtools fastqc snakemake numpy
...
### Consensus peaksets for biological
