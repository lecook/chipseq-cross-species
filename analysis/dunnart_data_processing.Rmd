...
![Pearson correlation dunnart BAM files](pearsoncor_multibamsum.pdf)
...
![Fingerprint plot for dunnart BAM files](multiBAM_fingerprint.pdf)
...
![Fragment size for read pairs in a BAM file](bamPEFragmentSize_hist.pdf)
