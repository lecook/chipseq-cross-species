...
![Pearson correlation dunnart downsampled BAM files](output/qc/pearsoncor_multibamsum_dunnart_downSampled.png)
![Pearson correlation mouse downsampled BAM files for H3K4me3](output/qc/H3K4me3_pearsoncor_multibamsum_mouse.png")
![Pearson correlation mouse downsampled BAM files for H3K27ac](output/qc/H3K27ac_pearsoncor_multibamsum_mouse.png")
...
![Fingerprint plot for dunnart downsampled BAM files](output/qc/multiBAM_fingerprint_dunnart_downSampled.png)
![Fingerprint plot for mouse downsampled BAM files for H3K4me3](output/qc/H3K4me3_multiBAM_fingerprint_mouse.png)
![Fingerprint plot for mouse downsampled BAM files for H3K27ac](output/qc/H327ac_multiBAM_fingerprint_mouse.png)
