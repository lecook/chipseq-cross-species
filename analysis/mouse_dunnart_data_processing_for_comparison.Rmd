...
```{r, echo=FALSE, out.width="50%", fig.cap="Pearson correlation dunnart downsampled BAM files"}
knitr::include_graphics("docs/pearsoncor_multibamsum_dunnart_downSampled.pdf")
```

```{r, eval=FALSE, echo=FALSE, out.width="50%", fig.cap="Pearson correlation mouse downsampled BAM files for H3K4me3"}
knitr::include_graphics("docs/H3K4me3_pearsoncor_multibamsum_mouse.pdf")
```

```{r, eval=FALSE, echo=FALSE, out.width="50%", fig.cap="Pearson correlation mouse downsampled BAM files for H3K4me3"}
knitr::include_graphics("docs/H3K27ac_pearsoncor_multibamsum_mouse.pdf")
```
...
![Fingerprint plot for mouse downsampled BAM files for H3K27ac](H3K27ac_multiBAM_fingerprint_mouse.pdf)
