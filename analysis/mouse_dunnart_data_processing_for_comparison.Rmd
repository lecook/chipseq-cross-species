...
##### Dunnart
```{bash}
less output/peaks/H3K4me3_overlap_default_dunnart_downSampled.narrowPeak | wc -l
less output/peaks/H3K27ac_overlap_default_dunnart_downSampled.narrowPeak | wc -l
```
